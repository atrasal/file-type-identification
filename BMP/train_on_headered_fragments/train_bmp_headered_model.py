...
TRAIN_DIR = os.path.abspath(os.path.join(BASE_DIR, '..', 'fragments_with_header_footer', 'train_fragments'))# For headerless, use:
# TRAIN_DIR = os.path.join(BASE_DIR, 'fragments_headerless_footerless', 'train_fragments')
